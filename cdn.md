...
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
   ...
   │      │LVS with VIP│          │LVS with VIP│            │LVS with VIP│                    │   ......   │                │LVS with VIP│       │  address   │       │  address   │     │  
   │      │address VIP3│          │address VIP4│            │address VIP5│                    │            │                │address VIP9│       │   VIP10    │       │   VIP11    │     │  
   │      │            │          │            │            │            │                    │            │                │            │       │            │       │            │     │  
   │      └────────────┘          └────────────┘            └────────────┘                    └────────────┘                └────────────┘       └────────────┘       └────────────┘     │  
   │                                                                                                                                                                                     │  
   │                                                                                                                                                                                     │  
   ...
   ┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐   
   │                                     Usually two L1 CDN cache cluster is deployed within a single region for resiliency and performance purpose                                     │   
   │                                                                                                                                                                                    │   
   │      ┌─────────────────────────────────────────────────────────────────────────┐                ┌─────────────────────────────────────────────────────────────────────────┐        │   
   │      │                                Cluster 1                                │  .─────────.   │                                Cluster 2                                │        │   
   │      │                                                                        _.─'           `──.                                                                         │        │   
   │      │                                                                       ╱Local cache server ╲                                                                        │        │   
   │      │   .───────────────.      .───────────────.       .───────────────.   ;   such as Nginx,    : .───────────────.      .───────────────.       .───────────────.      │        │   
   │      │  (  Cache server   )    (  Cache server   )     (  Cache server   )  :  Varnish, Traffic   ;(  Cache server   )    (  Cache server   )     (  Cache server   )     │        │   
   │      │   `───────────────'      `───────────────'       `───────────────'    ╲      server       ╱  `───────────────'      `───────────────'       `───────────────'      │        │   
   │      │           ▲                      ▲                       ▲             ╲                 ╱           ▲                      ▲                       ▲              │        │   
   │      │           │                      │                       │              `──.         _.─'│           │                      │                       │              │        │   
   │      │           │                      │                       │              │   `───────'    │           │                      │                       │              │        │   
   ...
   │      │           │                      │                       │             _.─'           `──.           │                      │                       │              │        │   
   │      │      .─────────.            .─────────.              .─────────.      ╱  L7 Cache server  ╲     .─────────.            .─────────.              .─────────.        │        │   
   │      │     (  HAProxy  )          (  HAProxy  )            (  HAProxy  )    ;   such as Nginx,    :   (  HAProxy  )          (  HAProxy  )            (  HAProxy  )       │        │   
   │      │      `─────────'            `─────────'              `─────────'     :       HAProxy       ;    `─────────'            `─────────'              `─────────'        │        │   
   │      │           ▲                      ▲                        ▲           ╲                   ╱          ▲                      ▲                        ▲             │        │   
   │      │           │                      │                        │            ╲                 ╱           │                      │                        │             │        │   
   │      │           └──────────────────────┼────────────────────────┘             `──.         _.─'│           │                      │                        │             │        │   
   ...
   │      │                           .─────────────.                               │                │                           .──────┴──────.                               │        │   
   │      │                       _.─'               `──.                           │  .───────────. │                       _.─'               `──.                           │        │   
   │      │                      ╱  LVS with virtual IP  ╲                         _.─'             `┴─.                    ╱  LVS with virtual IP  ╲                          │        │   
   │      │                     (      address VIP1       )                       ;    Level 4 load     :                  (      address VIP2       )                         │        │   
   │      │                      `.                     ,'                        :  balancer such as   ;                   `.                     ,'                          │        │   
   │      │                        `──.             _.─'                           ╲     LVS / F5      ╱                      `──.             _.─'                            │        │   
   │      │                            `───────────'                                `──.           _.┬'                           `───────────'                                │        │   
   │      │                                                                         │   `─────────'  │                                                                         │        │   
   ...
   └───────────────────────────────────────────┼──────────────────────────────────────────────────────────────────────────────────────────┼─────────────────────────────────────────────┘   
                                               ...
                                               │                                                                                          │                                                 
                                               │                                                                                          │                                                 
                                           Request 1             return               .───────────────.                return         Request 2                                             
                                               │             ◀────VIP1─────────────  (    CDN GLSB     ) ───────────────VIP2──────▶       │                                                 
                                               │                                      `───────────────'                                   │                                                 
                                               │                                                                                          │                                                 
                                               │                                                                                          │                                                 
