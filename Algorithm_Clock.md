...
- [Time](#time)
  ...
  - [Physical clocks](#physical-clocks)
    - [Quartz clock in computers](#quartz-clock-in-computers)
      - [Def](#def)
      - [Accuracy](#accuracy)
      - [Cons](#cons)
  ...
  - [Physical time](#physical-time)
    ...
    - [Could physical clock be used to order events](#could-physical-clock-be-used-to-order-events)
    - [Network time protocol (NTP)](#network-time-protocol-ntp)
      - [Architecture](#architecture)
        - [Why hierarchy of time servers](#why-hierarchy-of-time-servers)
      - [Accuracy](#accuracy-3)
      - [Public NTP servers](#public-ntp-servers)
        - [How will server sync to NTP](#how-will-server-sync-to-ntp)
  - [Logical clock](#logical-clock)
    - [Lamport logical clock](#lamport-logical-clock)
      - [Algorithm](#algorithm)
      - [Cons](#cons-3)
    - [Vector clock](#vector-clock)
      ...
      - [Pros](#pros)
    - [Concurrent version clock](#concurrent-version-clock)
      - [Def](#def-4)
    - [Version vector](#version-vector)
      - [Def](#def-5)
      - [Client/Server side ID generation](#clientserver-side-id-generation)
    - [Dotted verion vector](#dotted-verion-vector)
      - [Pros](#pros-1)
      - [Cons](#cons-4)
  - [Hybrid logical clock (HLC)](#hybrid-logical-clock-hlc)
    ...
    - [Adopters](#adopters)
      - [Yugabyte DB's implementation](#yugabyte-dbs-implementation)
...
![](images/algorithm_clock_DvvAlgorithm.png)
...
![](./images/algorithm_clock_hybridClock.png)
...
![](./images/algorithm_clock_truetime.png)
