...
- [Naive solution](#naive-solution)
  ...
  - [Improved Storage design: Message and thread table](#improved-storage-design-message-and-thread-table)
    ...
    - [Pros](#pros)
    - [Cons](#cons)
- [[Must-have Functional features] Notifications](#must-have-functional-features-notifications)
  ...
  - [Notification technologies](#notification-technologies)
    ...
    - [Push model (WebSocket)](#push-model-websocket)
      - [Websocket](#websocket)
      - [Heartbeat](#heartbeat)
- [[Nice-to-have Functional features] Online status](#nice-to-have-functional-features-online-status)
...
- [[Nice-to-have functional features] Unread messages](#nice-to-have-functional-features-unread-messages)
...
- [[Must-have nonfunctional features] Reliability (No missing and duplication)](#must-have-nonfunctional-features-reliability-no-missing-and-duplication)
...
# [Must-have Functional features] Notifications
...
# [Nice-to-have Functional features] Online status
...
# [Nice-to-have functional features] Unread messages
...
# [Must-have nonfunctional features] Reliability (No missing and duplication)
