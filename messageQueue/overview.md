...
- [Use cases](#use-cases)
  - [Rate limiting in high concurrent scenarios](#rate-limiting-in-high-concurrent-scenarios)
    - [Example - Promotion activity in online selling platforms](#example---promotion-activity-in-online-selling-platforms)
    - [Example Decoupling in asynchronous scenarios for better performance](#example-decoupling-in-asynchronous-scenarios-for-better-performance)
...
### Example - Promotion activity in online selling platforms
...
### Example Decoupling in asynchronous scenarios for better performance
